...
weighted Cox model (0.21, 0.39). Finally, it should be noted that results are
relatively consistent across all methods, the intervention treatment
significantly reduces the hazard of death compared with the comparator
treatment.
```{r}
## Calculate HRs
...
the plot does not appear normally distributed, this suggests the BCa approach is
more appropriate.
...
with the OR of 3.79 from the weighted logistic regression model. Both the
confidence interval from the bootstrap percentiles is narrower (2.41 to 5.10)
than the interval from the weighted logistic regression model (2.56 to 5.60).
Finally, it should be noted that results are relatively consistent across all
methods, the intervention treatment significantly increases the odds of response
compared with the comparator treatment.
...
To test the distribution of the bootstrapped ORs, a histogram can be plotted. If the plot does not appear normally distributed, this suggests the BCa approach is more appropriate.
